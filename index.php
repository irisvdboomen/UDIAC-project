...
<body>
    ...
    <div class="all-boxes">
        ...
        <div class="box1" id="bottom1">
            <p>those match sticks can be used on<br> different rewards. check out the<br> <a href="#">challenges</a> and <a href="rewards.php">rewards</a>.</p>
        </div>
    </div>
    <!-- beginning of footer -->
    <footer>
            ...
            <div class="right-part-footer">
                <div class="page-links">
                    ...
                    <div class="three-links">
                        ...
                        <p><a href="challenge.ph">Challenges</a></p>
