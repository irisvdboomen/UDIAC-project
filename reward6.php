...
if(isset($_POST['btn_use_points'])){
    ...
    if($activePoints >= $points){
            ...
            header("Location: reward6.php?reward=granded");
}else{
    ...
    <div class="reward-box">
        ...
        <div class="text-reward-box">
            ...
            <div class="other-text-reward-box">
                Spend 100 match sticks to use this reward anytime you want. When using this reward you can get one month free subscription on coffee beans.
